...
// initalizing blanks n html
document.getElementById("CurrentWord").innerHTML = lettersAndBlanksArray.join(" ");
	...
	if (event.key >= "a" & event.key <= "z") {
		...
		if (letterFound == false) {
			...
			if (incorrectLetterFound == false) {
				...
				document.getElementById("LettersGuessed").innerHTML = incorrectGuesses;
			}
